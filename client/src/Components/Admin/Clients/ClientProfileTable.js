...
function createData(id, product, client, date, number, status) {
  return { id, product, client, date, number, status };
}

const rows = [
  createData(
    1,
    "Escritorio Montessori",
    "cliente@armea.com",
    "12/12/2020 a las 13:32",
    19834,
    "Pendiente"
  ),
  createData(
